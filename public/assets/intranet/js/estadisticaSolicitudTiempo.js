...
const cargarTableCyc = (solicitudesList) =>{
    ...
    for(let i = 0; i < solicitudesList.length; i++){
        ...
        if(solicitudesList[i].status == "Rechazada")
            auxList.push(`<button class="btn btn-danger btn-circle float-right"><i class="fas fa-times"></i></button>`);
        else
            auxList.push(`<button class="btn btn-success btn-circle float-right"><i class="fas fa-check"></i></button>`);
        // dateFilter(solicitudesList[i].date);
        // auxList.push(solicitudesList[i].dateAltaIntelisis);
        // auxList.push(solicitudesList[i].datePCompra);
        // auxList.push(solicitudesList[i].importePCompra);
