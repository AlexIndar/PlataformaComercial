                ...
                for (var x = 0; x < data.length; x++) {
                    ...
                    if (sub == undefined) {
                        ...
                        var json = {
                            ...
                            incluyeProveedores: incluyeProveedores,
                            marcas: marcas,
                            incluyeMarcas: incluyeMarcas,
                            articulos: articulos,
                            incluyeArticulos: incluyeArticulos,
                        };
    ...
    if (validarSubregla()) {
        if (document.getElementById('indexSubregla').value != '') {
            ...
            if (articulos.length > 0) {
                optionsArticulos = $("#articulos option:selected");
            ...
            //remove brackets from items list if list is black
            ...
            var json = {
                ...
                regalos: regalos,
                proveedores: proveedores,
                incluyeProveedores: document.getElementById('listaProveedores').value == 'negra' ? false : true,
                marcas: marcas,
                incluyeMarcas: document.getElementById('listaMarcas').value == 'negra' ? false : true,
                articulos: articulos,
                incluyeArticulos: document.getElementById('listaArticulos').value == 'negra' ? false : true,
            };
...
function editSubregla(id) {
    ...
    var negativeMarcas = reglas[6].filter(x => !subreglas[index]['marcas'].includes(x));
    var negativeProveedores = reglas[5].filter(x => !subreglas[index]['proveedores'].includes(x));
    console.log(negativeProveedores);
    // necesito los codigos de articulo sin descripción para sacar el negativo en lista negra y poder asignarlos al choose
    ...
    let negativeArticulos = tempArticulosReglas.filter(x => !subreglas[index]['articulos'].includes(x));

    if (subreglas[index]['incluyeMarcas']) {
        $('#listaMarcas').val('blanca');
    ...
    if (subreglas[index]['incluyeProveedores']) {
        $('#listaProveedores').val('blanca');
    ...
    if (subreglas[index]['incluyeArticulos']) {
        $('#listaArticulos').val('blanca');
    ...
    console.log('Proveedores: '+subreglas[index]['incluyeProveedores']);

    subreglas[index]['incluyeMarcas'] ? $('#marcas').val(subreglas[index]['marcas']).trigger('chosen:updated') : $('#marcas').val(negativeMarcas).trigger('chosen:updated');
    subreglas[index]['incluyeProveedores'] ? $('#proveedores').val(subreglas[index]['proveedores']).trigger('chosen:updated') : $('#proveedores').val(negativeProveedores).trigger('chosen:updated');
    subreglas[index]['incluyeArticulos'] ? $('#articulos').val(subreglas[index]['articulos']).trigger('chosen:updated') : $('#articulos').val(negativeArticulos).trigger('chosen:updated');
...
function updateRule() {
    ...
    subreglas[index]['proveedores'] = proveedores;
    document.getElementById('listaProveedores').value == 'negra' ? subreglas[index]['incluyeProveedores'] = false : subreglas[index]['incluyeProveedores'] = true;
    subreglas[index]['marcas'] = marcas;
    document.getElementById('listaMarcas').value == 'negra' ? subreglas[index]['incluyeMarcas'] = false : subreglas[index]['incluyeMarcas'] = true;
    subreglas[index]['articulos'] = articulos;
    document.getElementById('listaArticulos').value == 'negra' ? subreglas[index]['incluyeArticulos'] = false : subreglas[index]['incluyeArticulos'] = true;
    ...
    for (var y = 0; y < subreglas.length; y++) {
        ...
        for (var x = 0; x < subreglas[y]['proveedores'].length; x++) {
            listaPedidoPromoRulesD.push({
                ...
                incluye: subreglas[y]['incluyeProveedores'],
                idPedidoPromoNavigation: ''
            });
        }
        ...
        for (var x = 0; x < subreglas[y]['marcas'].length; x++) {
            listaPedidoPromoRulesD.push({
                ...
                incluye: subreglas[y]['incluyeMarcas'],
                idPedidoPromoNavigation: ''
            });
        }
        ...
        for (var x = 0; x < subreglas[y]['articulos'].length; x++) {
            listaPedidoPromoRulesD.push({
                ...
                incluye: subreglas[y]['incluyeArticulos'],
                idPedidoPromoNavigation: ''
            });
        }
...
function storeHeader() {
    ...
    //remove brackets from customers list if list is black
