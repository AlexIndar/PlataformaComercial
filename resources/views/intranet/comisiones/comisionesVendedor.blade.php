                        ...
                        <div class="col-md-12">
                            <div class="card-body table-responsive p-0">
                                <table id="bonosTable" class="table table-striped table-bordered table-hover "
                                    ...
                                    <thead style="background-color:#002868; color:white">
                                        <tr>
                                            <th id="headerMes" class="text-center" style="font-size:15px " colspan=7>
                                                ESPECIALES</th>
                                        </tr>
                                        <thead style="background-color:#002868; color:white">
                                            <tr>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (Array.isArray(zonavar)) {
                ...
                $.each(zonavar, function(id, name) {
                    //console.log(id,name);
                    $selectZonas.append('<option value=' + name.description + '>' + name.description +
                        '</option>');
                });
            } else {
        ...
        function consultar() {
            ...
            var month = dateprueba.toLocaleString('default', {
                month: 'long'
            });
                ...
                success: function(data) {
                    ...
                    if (html == '') {
                        html += '<tr>' +
                            ...
                            '<td style="font-weight: bold; cursor: pointer "><a href="/comisionesPorCliente" target="_blank">' +
                            sumaRMCI.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</a></td>' +
                            '<td style="font-weight: bold">' + sumaRMSI.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaPSMASI.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaPSEMSI.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaRMSI.toLocaleString('es-MX', {
                        ...
                        htmlmn += '<tr>' +
                            ...
                            '<td style="font-weight: bold">' + sumaMN30.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMN60.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMN90.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMN90mas.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMNtotal.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMNCB.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</tr>';
                        ...
                        htmlmb += '<tr>' +
                            ...
                            '<td style="font-weight: bold">' + sumaMB30.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMB60.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMB90.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMB90mas.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMBtotal.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaMBCB.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</tr>';
                        ...
                        htmlsubtotal += '<tr style ="background-color: rgba(231, 235, 11, 0.705)">' +
                            ...
                            '<td style="font-weight: bold">' + sumaTotal30.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaTotal60.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaTotal90.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaTotal90mas.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaTotalImporte.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td id ="totalComision" style="font-weight: bold">' + sumaCBtotal.toLocaleString(
                                'es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + '</td>' +
                        ...
                        if (sumaDescneg == 0) {
                            ...
                            desneg =
                                '<tr onClick="detalleDesc(1);" style="cursor: pointer" data-toggle="modal" data-target="#descModal">';
                        }
                        if (sumaDesFT == 0) {
                            desft = '<tr>';
                        } else {
                        ...
                        htmldescComi += desneg +
                            ...
                            '<td style="font-weight: bold">' + sumaImpD.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">21.49 %</td>' +
                            '<td style="font-weight: bold">' + sumaDescneg.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaDescneg.toLocaleString('es-MX', {
                            ...
                            '<td style="font-weight: bold">' + sumaImpF.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">21.49 %</td>' +
                            '<td style="font-weight: bold">' + sumaDesFT.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaDesFT.toLocaleString('es-MX', {
                            ...
                            '<td style="font-weight: bold">' + sumaImpI.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">21.49 %</td>' +
                            '<td style="font-weight: bold">' + sumaIncob.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold">' + sumaIncob.toLocaleString('es-MX', {
                        ...
                        htmlDespensa += '<tr>' +
                            ...
                            '<td style="font-weight: bold" colspan="2">' + despensa.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</tr>';
                    ...
                    myCallback(sumaCBtotal.toLocaleString('es-MX', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
                },
                ...
                $.ajax({
                    ...
                    success: function array(data) {
                        ...
                        events.push({
                            ...
                            start: data[0].fechaInicioPeriodo,
                            backgroundColor: 'green'
                        });
                        events.push({
                            title: 'Fin del Periodo',
                            start: data[0].fechaFinPeriodo,
                            backgroundColor: 'red'
                        });
                        ...
                        var rawtDataNoActivos = data[0]
                        .detalleVisitadosNoAct; //agrupar Clientes Visitados No Activos
                        ...
                        for (i = 0; i < resultData.length; i++) {
                            ...
                            htmlModal += '<tr>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + resultData[i]
                                .companyname + '</td>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + resultData[i]
                                .codigo + '</td>' +
                                '</tr>';
                        ...
                        for (i = 0; i < resultNoAct.length; i++) {
                            ...
                            htmlCtesNoActivos += '<tr>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + resultNoAct[i]
                                .companyname + '</td>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + resultNoAct[i]
                                .codigo + '</td>' +
                                '</tr>';
                        ...
                        for (i = 0; i < ctesNoVisitados.length; i++) {
                            ...
                            htmlCtesNoVisitados += '<tr>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + ctesNoVisitados[i]
                                .companyName + '</td>' +
                                '<td style="font-weight: bold; background-color:#f9ea45">' + ctesNoVisitados[i]
                                .companyId + '</td>' +
                                '</tr>';
                        ...
                        for (i = 0; i < bonoDetalle.length; i++) {
                            ...
                            if (bonoDetalle[i].giro_id == 30 || bonoDetalle[i].giro_id == 45) {
                                htmlModalnc += '<tr>' +
                                    '<td style="font-weight: bold; background-color:#f9ea45">' + bonoDetalle[i]
                                    .companyid + '</td>' +
                                    '<td style="font-weight: bold; background-color:#f9ea45">' + bonoDetalle[i]
                                    .companyname + '</td>' +
                                    '<td style="font-weight: bold; background-color:#f9ea45">' + bonoDetalle[i]
                        ...
                        if (data[0].diasLaborados == 0) {
                            ...
                            '<td style="cursor: pointer"  data-toggle="modal" data-target="#diasModal">';
                        ...
                        var comisionInt = parseFloat(comisionTot) + parseFloat(importePunt) + parseFloat(
                            comisionTot * 0.10);
                        ...
                        htmlPuntualidad += '<tr>' +
                            ...
                            '<td style="font-weight: bold" colspan="2">' + importePunt.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</td>' +
                            ...
                            '<td style="font-weight: bold; cursor: pointer"  data-toggle="modal" data-target="#diasNoLaboradosModal"><u>' +
                            data[0].diasNoLAborados + '</u></td>' +
                            '<td style="font-weight: bold"> NA </td>' +
                            '<td style="font-weight: bold; color:red" colspan="2"> -' + importdiasNoLaborados
                            ...
                            '<td style="font-weight: bold" colspan="2">' + comisionInt.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</tr>';
                        ...
                        if (data[1].nuevosMesActualRoTP == 0) {
                            ctesnvos = '<td style="font-weight: bold"><u>' + data[1].nuevosMesActualRoTP +
                                '</u></td>';
                        } else ctesnvos =
                            '<td style="font-weight: bold; cursor: pointer" data-toggle="modal" data-target="#nvosclientesModal" ><u>' +
                            data[1].nuevosMesActualRoTP + '</u></td>';
                        htmlBonos += '<tr>' +
                            '<td style="font-weight: bold" >Clientes Activos</td>' +
                            '<td style="font-weight: bold; cursor: pointer" data-toggle="modal" data-target="#editarVo""><u>' +
                            data[1].vo + '</u></td>' +
                            '<td style="font-weight: bold" >' + le + '</td>' +
                            '<td style="font-weight: bold" >' + data[1].real + '</td>' +
                            '<td style="font-weight: bold" >' + bonosPorc.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + ' % </td>' +
                            '<td style="font-weight: bold" >' + bonoImp.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '</tr>';
                        ...
                        if (data[2].hasOwnProperty('status')) {
                            ...
                            htmlVentas += '<tr>' +
                                '<td style="font-weight: bold" >Total de Ventas en la Zona</td>' +
                                '<td style="font-weight: bold "> ' + data[2].vo.toLocaleString('es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + ' </td>' +
                                '<td style="font-weight: bold" > ' + data[2].le.toLocaleString('es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + ' </td>' +
                                '<td style="font-weight: bold" > ' + data[2].real.toLocaleString('es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + '</td>' +
                                '<td style="font-weight: bold" >' + vtasPorc.toLocaleString('es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + ' %</td>' +
                                '<td style="font-weight: bold" >' + vtasImporte.toLocaleString('es-MX', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                }) + '</td>' +
                                '</tr>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        htmlModalDesc += '<tr>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].companyid +
                            '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].companyname +
                            '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].tranid +
                            '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            .recibo_mes_actual.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            .recibo_mes_actual_siniva.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            .pendiente_saldar_mes_anteriorl_siniva.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            ...
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].descneg
                            .toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            .descuento_fuera_tiempo.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i]
                            .incobrabilidadADescontar.toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].incobrabilidad
                            .toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
                            '<td style="font-weight: bold; background-color:#f9ea45">' + data[i].comision_base
                            .toLocaleString('es-MX', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            }) + '</td>' +
