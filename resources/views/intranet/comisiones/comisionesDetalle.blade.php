...
<div id = "show" class="content-wrapper" style="min-height: 2128.12px; display:none">
    <div class="content-header">
       <div class="container-fluid">
          <div class="row mb-2">
             <div class="col-sm-6">
                <h5 class="m-0">Comisiones | Detalle de Cobranza </h5>
             </div>
             <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                   <li class="breadcrumb-item"><a href="#">Comisiones</a></li>
        ...
        success: function(data){
           console.log(data);
            ...
            if(html !== ''){
                ...
                '<td style="font-weight: bold">'+sumaSMSI.toLocaleString('es-MX')+'</td>'+
                '<td style="font-weight: bold">'+sumaPSEMSI.toLocaleString('es-MX')+'</td>'+
                '<td style="font-weight: bold">NA</td>'+
                '<td style="font-weight: bold">NA</td>'+
                '<td style="font-weight: bold">NA</td>'+
                '<td style="font-weight: bold"> </td>'+
                '<td style="font-weight: bold">'+sumaIFac.toLocaleString('es-MX')+'</td>'+
                '<td style="font-weight: bold">'+sumaSaldo.toLocaleString('es-MX')+'</td>'+
                '<td style="font-weight: bold">0</td>'+
                '<td style="font-weight: bold">0</td>'+
                '<td style="font-weight: bold">0</td>'+
                '<td style="font-weight: bold">'+sumaCB.toFixed(2)+'</td>';
               $('#llenaTable').html(html);
               $('#llenaTable').append(htmlfoot);
