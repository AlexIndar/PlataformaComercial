        ...
        <div class="container-fluid text-indarBlue">
            <div class="row mb-2">
                <div class="col-sm-8">
                    ...
                    @else
                    <input type="text" id="zoneP" value="{{$zone}}" hidden>
                    @endif
                </div>
                <div class="col-sm-4">
                                        ...
                                        <div id="datosContacto" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <label class="input-group-text" for="tipoContacto">Tipo de contacto</label>
                                                        </div>
            ...
            <div class="modal-body" id="bodycontactosEdit" style="text-align: center;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="tipoContactoEdit">Tipo de contacto</label>
                            </div>
                            <select class="custom-select" id="tipoContactoEdit">
                                <option selected>SELECCIONAR</option>
                                <option value="1">PRINCIPAL</option>
                                <option value="2">PAGOS</option>
                                <option value="3">COMPRAS</option>
...
@section('js')
<script src="{{asset('assets/intranet/js/misSolicitudesAdmin.js')}}"></script>
<!-- DataTables  & Plugins -->
