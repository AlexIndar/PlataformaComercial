...
@section('title') Indar - Centros de cruce @endsection
    ...
    <div class="section">
        <div class="section-body">
            <div class="section-title">
                <h3 data-aos="fade-right" data-aos-duration="2000">Centros de cruce:</h3>
            </div>
            <br><br>
                    ...
                    <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                       ...
                       <div class="row">
                           <div class="col-lg-3 col-md-4 col-sm-6">
                               <img class="appear-1000" width="90%" height="auto" src="{{asset('assets/customers/img/jpg/centros/cci.jpg')}}" alt="">
