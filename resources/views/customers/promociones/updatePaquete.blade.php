...
<div class="content-wrapper p-5">
    <div class="container-fluid">
        ...
        <input type="text" name="tipoPromo" id="tipoPromo" value="paquete" hidden>
            ...
            <div class="content-datos-generales">
                ...
                <div class="row reglas-row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <input class="input-promociones" type="number" name="preciomin" id="preciomin" step=".01" min="0" value="{{$promo->montoMinCash}}">
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <input class="input-promociones" type="number" name="cantidadmin" id="cantidadmin" value="1" step="1" min="0" value="{{$promo->montoMinQty}}">
                    </div>
                </div>
