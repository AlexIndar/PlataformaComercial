     ...
     <div class="container-fluid">
         ...
         <div class="content">
                         ...
                         <div class="row">
                             ...
                             @if (count($data) == 1)
                                 <div class="col-lg-10 col-md-10 col-12 rowPedido"><input type="text" class="inputPedido"
                                         id="correo" name="correo" value="{{ $data[0]['email'] }}"></div>
                             @else
             ...
             <div id="pedido" style="display:none;">
                 ...
                 <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" id="modalPedidosClientes"
                     aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                     <div class="modal-dialog modal-xl">
                         <div class="modal-content modal-content-inventario">
                             <input type="text" id="emptyPedidosClientes" value="yes" hidden>
                             <i class="fa-solid fa-lg fa-xmark" id="closeModalInventario"
                                 style="cursor: pointer; margin-top: -8px;" onclick="closeModalPedidosClientes()"></i>
                             <br><br>
                             <table id="tablaPedidosClientes"
                                 class="table-striped table-bordered table-hover compact display" style="width:100%">
                                 <thead>
                                     <tr>
