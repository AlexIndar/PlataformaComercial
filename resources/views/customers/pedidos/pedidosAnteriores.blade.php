    ...
    <div style="overflow-x: hidden !important; padding: 0px 30px 0px 30px !important;">
        ...
        <div class="row d-flex justify-content-center align-items-center flex-row">
            <div class="col-lg-4 col-12 text-center" style="margin-top:10px;">
                <h4>Cotización</h4>
                <input type="text" id="findCotizacion"
                    style="border: 1px solid black !important; height: 30px !important; width: 100% !important; background-color: #F7F5FF !important;">
            </div>
            <div class="col-lg-4 col-6 text-center flex flex-row" style="margin-top:10px;">
                <h4>Año</h4>
                <select id="findYear"
                    style="border: 1px solid black !important; height: 30px !important; width: 100%; background-color: #F7F5FF !important;">
            ...
            @else
                @foreach ($saleOrders as $order)
                    <div class="col-lg-1 col-md-2 col-sm-3 col-6 box"
                        onclick="openDetail('{{ $order->numPedido }}', '{{ $order->numFactura }}')">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="bodyModalDetail">
                    ...
                    <div class="exportFiles">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end" style="padding: 0px 50px 0px 50px">
                                <img id="iconDescargarPdf" title="Descargar pdf"
                                    src="{{ asset('assets/customers/img/png/pdf.png') }}"
                                    style="width:35px; height: auto; margin-right: 10px; cursor: pointer;" alt="pdf">
                                <img id="iconDescargarXml" title="Descargar xml"
                                    src="{{ asset('assets/customers/img/png/xml.png') }}"
                                    style="width:35px; height: auto; cursor:pointer;" alt="xml">
                            </div>
                        </div>
                    </div>
                    <div class="saleOrderDetail mt-5" id='saleOrderDetail'>
                        <table id="tablaDetalle" class="table-striped table-bordered table-hover compact display"
                            style="width:100%">
                            <thead>
                                <tr>
