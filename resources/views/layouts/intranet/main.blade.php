...
<body id='body' class="hold-transition sidebar-mini layout-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="logo" id="logo" src="{{ asset('assets/customers/img/png/indar.png') }}"
        ...
        <nav class="main-header navbar navbar-expand bg-indarBlue">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link icon-indar" data-widget="pushmenu" href="#" role="button"><i
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <a href="Intranet" class="brand-link">
                <img class="logo" src="{{ asset('assets/customers/img/png/indar.png') }}" alt="Login image"
                    width="200" style="padding:10px; margin-left: 10px;">
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/customers/img/png/profile.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @if (in_array('Portal Viaticos', $permissions))
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="https://5327814.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=980&deploy=1&compid=5327814&h=a519d7a1694f67babcc1&ppConfId=1"
