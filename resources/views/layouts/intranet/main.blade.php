...
<body id='body' class="hold-transition sidebar-mini layout-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="logo" id="logo" src="{{asset('assets/img/logos/indar.png')}}" alt="Login image" width="250">
    </div>
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <a href="main" class="brand-link">
        <img class="logo" src="{{asset('assets/img/logos/indar.png')}}" alt="Login image" width="200" style="padding:10px; margin-left: 10px;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="http://192.168.70.108:8080/admin/dist/#/pedidos-int" class="nav-link">
            ...
            <li class="nav-item">
              <a href="http://192.168.70.108:8080/admin/dist/#/promociones/1" class="nav-link">
