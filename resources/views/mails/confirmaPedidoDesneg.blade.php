...
<body>
    <h4 style="line-height: 10px;">El usuario {{ $username }} ingresó un nuevo pedido con {{ $tipoDescuento }} del
        {{ $descuento }}% autorizado por {{ $autoriza }}</h4>
            ...
            @if ($pedido[$x]['regalo'] == 0)
                <tr>
                    ...
                    @else
                        ...
                        <th style='background-color:#002868; color:white; padding: 2px; text-align: center;'></th>
                        <th style='background-color:#002868; color:white; padding: 2px; text-align: center;'></th>
                        <th style='background-color:#002868; color:white; padding: 2px; text-align: center;'>Descuento:
                            {{ $pedido[$x]['descuento'] }}% Plazo: {{ $pedido[$x]['plazo'] }} Tipo:
                            {{ $pedido[$x]['tipo'] }} Subtotal: ${{ $pedido[$x]['subtotal'] }} Evento:
                            {{ $pedido[$x]['evento'] }}</th>
                        <th style='background-color:#002868; color:white; padding: 2px; text-align: center;'></th>
